...
public final class TruePowerComboStateRegistry {
    ...
    public static final RegistryObject<ComboState> VOID_SLASH = COMBO_STATE.register("void_slash", ComboState.Builder
        ...
        .addTickAction(ComboState.TimeLineTickAction.getBuilder()
            .put(16, livingEntity ->
                TruePowerAttackManager.doVoidSlashAttack(livingEntity, AttackManager.isPowered(livingEntity)
                    ? TruePowerCommonConfig.POWERED_VOID_SLASH_DAMAGE_FIRST.get()
                    : TruePowerCommonConfig.VOID_SLASH_DAMAGE.get()))
            .put(17, livingEntity -> {
        ...
        .addHitEffect((t, a) -> {
            ITruePowerStunData stunData = ITruePowerStunData.get(t);
            if (stunData != null) {
