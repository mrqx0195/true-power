...
public class TruePowerCommonConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_STUN_VALUE;
    
    public static final ForgeConfigSpec.BooleanValue MODIFY_SUMMONED_SWORD_DAMAGE;
    public static final ForgeConfigSpec.DoubleValue SUMMONED_SWORD_DAMAGE_MULTIPLIER;
    
    public static final ForgeConfigSpec.EnumValue<CollideAction> COLLIDE_ACTION;
    ...
    static {
        ...
        }
        {
            ...
            ENABLE_STUN_VALUE = commonBuilder
                .comment("Replace SlashBlade`s stun with Stun Value System. (default: true)")
