...
public final class ComboModifierData {
    public static final ResourceKey<Registry<ComboModifierEntry>> MODIFIER_REGISTRY_KEY = ResourceKey
        .createRegistryKey(TruePowerMod.prefix("combo_modifiers"));
    public static final ResourceKey<Registry<RemoveReleaseEntry>> REMOVE_RELEASE_REGISTRY_KEY = ResourceKey
        .createRegistryKey(TruePowerMod.prefix("remove_releases"));
